...
theme.bg_minimize = colors.surface0
theme.bg_systray = theme.bg_normal

theme.fg_normal = colors.text
theme.fg_focus = colors.sapphire
theme.fg_urgent = colors.base
theme.fg_minimize = colors.sapphire
...
theme.border_color_active = colors.surface0
...
theme.wallpaper = variables.wallpapers.default
